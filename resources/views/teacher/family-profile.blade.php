        ...
        <section class="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
            <div id="update-parent-profile" class="mb-4 rounded-xl border border-zinc-200 bg-zinc-50 p-3">
                ...
                <div class="mt-4 rounded-xl border border-zinc-200 bg-white p-3">
                    <h4 class="text-xs font-semibold uppercase tracking-wide text-zinc-600">Student Tags</h4>
                    <p class="mt-1 text-[11px] text-zinc-500">Tag setiap murid: B40, KWAP, RMT.</p>
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        <label class="inline-flex items-center gap-1 text-xs font-medium text-zinc-700">
                                            <input type="checkbox" name="is_b40" value="1" @checked((bool) $student->is_b40)>
                                            B40
                                        </label>
                                        <label class="inline-flex items-center gap-1 text-xs font-medium text-zinc-700">
                                            <input type="checkbox" name="is_kwap" value="1" @checked((bool) $student->is_kwap)>
                                            KWAP
                                        </label>
                                        <label class="inline-flex items-center gap-1 text-xs font-medium text-zinc-700">
                                            <input type="checkbox" name="is_rmt" value="1" @checked((bool) $student->is_rmt)>
                                            RMT
                                        </label>
